 ...
 */
public class BoardgameDetailsSharedEnter extends ChangeBounds {

    private static final String PROPNAME_BOUNDS = "android:changeBounds:bounds";
    private static final String PROPNAME_PARENT = "android:changeBounds:parent";

    public BoardgameDetailsSharedEnter(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
