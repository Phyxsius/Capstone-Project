...
package us.phyxsi.gameshelf.ui.transitions;
...
public class Pop extends Visibility {
    ...
    private static final String PROPNAME_ALPHA = "gameshelf:pop:alpha";
    private static final String PROPNAME_SCALE_X = "gameshelf:pop:scaleX";
    private static final String PROPNAME_SCALE_Y = "gameshelf:pop:scaleY";
